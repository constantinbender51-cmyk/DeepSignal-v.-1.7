...
def get_signal(last_50: list) -> Tuple[str, float, float]:
    prompt = (
        "You are a crypto strategist. Use indicators, trade on Fibonacci retracement + RSI. BUY/SELL will trigger a market order of size 1% of capital. If unsure FLAT, 0.0, 0.0, <str>. After 24 hours the trade will be automatically closed. Last 50 1-h candles:\n"
